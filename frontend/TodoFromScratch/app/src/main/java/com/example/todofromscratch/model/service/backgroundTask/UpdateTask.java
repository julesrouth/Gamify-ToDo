...
public class UpdateTask extends AuthenticatedTask {
    ...
    public UpdateTask(AuthToken authToken, Task task, Handler messageHandler) {
    ...
    protected void runTask() {
        try {
            ...
            UpdateTaskRequest request = new UpdateTaskRequest(authtoken, task);
            ...
            UpdateTaskResponse response = getServerFacade().updateTask(request, TaskService.GET_UPDATETASK_URL);
