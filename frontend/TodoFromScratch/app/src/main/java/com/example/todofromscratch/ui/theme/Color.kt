...
//val customPrimary = Color(0xFF03396C) // Color(0xFF011F4B) //Color.Gray
//val customSecondary = Color(0xFF03396C) //Color.LightGray
//val customTertiary = Color(0xFF005B96) //Color.Blue
////val customBackground = Color(0xFFFFFBFE)
////val customSurface = Color(0xFFFFFBFE)
////val customOnPrimary = Color.White
////val customOnSecondary = Color.White
////val customOnTertiary = Color.White
////val customOnBackground = Color(0xFF1C1B1F)
////val customOnSurface = Color(0xFF1C1B1F)
//val customPrimaryContainer = Color(0xFFB3CDE0) // Color(0xFF0000FF)
//val customSurfaceVariant = Color.LightGray

// USE THIS TOOL: https://m3.material.io/theme-builder#/custom
val md_theme_light_primary = Color(0xFF075CB9)
...
val md_theme_light_surfaceTint = Color(0xFF075CB9)
...
val md_theme_dark_tertiary = Color(0xFF4FDBD0)
...
val md_theme_dark_inversePrimary = Color(0xFF075CB9)
...
val seed = Color(0xFF005AB7)
val CustomColor1 = Color(0xFFF5CCAC)
val light_CustomColor1 = Color(0xFF8F4E00)
...
val dark_CustomColor1 = Color(0xFFFFB77A)
val dark_onCustomColor1 = Color(0xFF4C2700)
val dark_CustomColor1Container = Color(0xFF6D3A00)
